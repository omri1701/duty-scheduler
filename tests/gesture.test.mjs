...
function fixture(t){
 ...
 const detach=attachHoldDrag(root,()=>({enabled,onStart:k=>calls.push(['start',k]),onMove:k=>calls.push(['move',k]),onEnd:k=>calls.push(['end',k]),onCancel:()=>calls.push(['cancel'])}),ignore);
